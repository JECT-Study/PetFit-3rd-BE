...
public enum AuthUserErrorCode {
    ...
    EMAIL_NOT_FOUND(HttpStatus.BAD_REQUEST, "USER-400","이메일을 찾을 수 없습니다"),
    PROFILE_INFORMATION_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "USER-400","카카오 프로필 정보가 부족합니다."),
    AUTH_EMAIL_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER-404","해당 이메일을 가진 사용자가 없습니다."),;
